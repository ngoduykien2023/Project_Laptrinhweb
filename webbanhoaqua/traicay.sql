...
--
-- Host: 127.0.0.1
-- Generation Time: May 13, 2023 at 07:34 AM
...
(1, 'admin', 1, 'admin', 'Tạ Nguyễn', 'Thanh Nhân', 1);
...
(43, 46, '2023-05-13 05:31:27', '13/05/2020', 'Phù Cừ - Hưng Yên', 1);
...
(48, 'tạ nguyễn', 'thanh nhân', 866096164, ' trần cao phù cừ hưng yên', 'aileennnn310@gmail.com', 2, 'duykhoi', '3615358'),
...
(46, 3, 'Mãng Cầu Xiêm', 45000, 'mangcau.jpg', 'Ở nước ta mãng cầu xiêm chỉ trồng nhiều ở miền Nam, ra tới phía bắc Nha Trang thì ít gặp. Do đó, càng không thể trồng mãng cầu xiêm ở miền Bắc, đặc biệt là những tỉnh giữa miền Bắc như Vĩnh Phúc. – Độ pH thích hợp cho cây là từ 5,0 – 6,5', '2023-05-13 05:21:26', 1),
(45, 2, 'Măng Cụt Bình Dương', 65000, 'Măng cụt 1.JPG', 'Măng cụt hay còn được gọi là quả tỏi ngọt, là một loài cây thuộc họ Bứa. Nó cũng là loại cây nhiệt đới thường xanh cho quả ăn được, có nguồn gốc từ các đảo quốc Đông Nam Á. Nguồn gốc của nó là không chắc chắn do việc trồng trọt thời tiền sử rộng rãi.', '2023-05-12 19:05:36', 0),
(43, 3, 'Xoài Cát Hòa Lộc', 40000, 'xoài cát hòa lộc.jpg', 'Xoài cát Hòa Lộc là loại xoài đặc sản nổi tiếng của vùng đất Định Tường, một trong những loại trái cây chủ lực của Tiền Giang. Xoài cát Hòa Lộc là loại trái cây đặc sản của tỉnh Tiền Giang, và là sản phẩm trái cây đầu tiên được cấp bảo hộ chỉ dẫn địa lý', '2023-05-12 14:37:44', 1),
(44, 1, 'Ổi Thanh Hà ', 10000, 'ổi thanh hà.jpg', 'Ổi Thanh Hà được trồng trên địa bàn huyện Thanh Hà, tỉnh Hải Dương, Việt Nam. Nhờ điều kiện thổ nhưỡng, khí hậu phù hợp, ổi Thanh Hà đã trở thành đặc sản, cho hiệu quả kinh tế cao nhất trong nhóm cây ăn quả.', '2023-05-12 19:13:20', 1);
...
--
ALTER TABLE `qua`
  MODIFY `ma_qua` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
